package com.n33.learn.java8time;
...
public class Java8TimeTest {
    ...
    public static void main(String[] args) {
        ...
        LocalDate localDate2 = LocalDate.of(2019, 4, 14);
        ...
        //MonthDay monthDay2 = MonthDay.from(LocalDate.of(2011, 3, 25));//只关注月日
        ...
        //LocalDate localDate6 = LocalDate.of(2019, 4, 15);
        LocalDate localDate6 = LocalDate.of(2019, 4, 16);
        ...
        LocalDate localDate8 = LocalDate.of(2019, 4, 25);
